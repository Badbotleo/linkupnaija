...
> = {
  ...
  "Fitness Class": { badge: "bg-gray-100 text-gray-700", emoji: "🏋️" },
  ...
  "Music Jam": { badge: "bg-gray-100 text-gray-700", emoji: "🎸" },
...
export const CATEGORY_GRADIENTS: Record<EventCategory, string> = {
  ...
  "Fitness Class": "from-lime-500 to-green-600",
  ...
  "Music Jam": "from-violet-500 to-purple-700",
