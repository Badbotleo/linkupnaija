...
export default function BannerUpload({
  ...
  return (
    <div className="relative h-36 w-full overflow-hidden sm:h-52">
      ...
      {editable && (
        <label className="absolute bottom-3 right-3 flex cursor-pointer items-center gap-1.5 rounded-full bg-black/50 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur transition hover:bg-black/60">
